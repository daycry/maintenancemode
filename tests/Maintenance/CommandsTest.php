...
final class CommandsTest extends TestCase
{
    ...
    public function testDownCommandBasic(): void
    {
        ...
        $this->assertSame('Basic test message', $data->message);
        $this->assertSame(['127.0.0.1'], $data->allowed_ips);
    }
    ...
    public function testDownCommandWithMultipleIps(): void
    {
        ...
        $this->assertSame(['192.168.1.100', '10.0.0.0/8'], $data->allowed_ips);
    }
    ...
    public function testDownCommandWithSecret(): void
    {
        ...
        $this->assertSame('my-test-secret', $data->secret_key);
    }
    ...
    public function testDownCommandWithAllOptions(): void
    {
        ...
        $this->assertSame(['192.168.1.100'], $data->allowed_ips);
        $this->assertTrue($data->secret_bypass);
    ...
    public function testDownCommandWhenAlreadyActive(): void
    {
        ...
        $data = $storage->getData();
        $this->assertSame('Already active', $data->message);
    }
    ...
    public function testCommandsWithCacheConfiguration(): void
    {
        ...
        $data = $storage->getData();
        $this->assertSame('Cache config test', $data->message);
    ...
    public function testCommandsWithFileConfiguration(): void
    {
        ...
        $data = $storage->getData();
        $this->assertSame('File config test', $data->message);
    ...
    public function testCommandsWithSpecialCharacters(): void
    {
        ...
        $this->assertSame($specialMessage, $data->message);
    }
    ...
    public function testCommandsWithLongValues(): void
    {
        ...
        $this->assertSame($longMessage, $data->message);
        $this->assertSame($longSecret, $data->secret_key);
    }
    ...
    public function testConfigSecretBypassInCommands(): void
    {
        ...
        $this->assertSame('config-bypass-secret', $config->secretBypassKey);
    }
    ...
    public function testDataSecretBypassInCommands(): void
    {
        ...
        $this->assertTrue($data->secret_bypass);
        $this->assertSame('data-bypass-secret', $data->secret_key);
    }
    ...
    public function testMultipleBypassMethodsInCommands(): void
    {
        ...
        $this->assertSame(['192.168.1.100'], $data->allowed_ips); // IP bypass
        $this->assertSame('bypass_cookie', $data->cookie_name); // Cookie bypass
    }
}
